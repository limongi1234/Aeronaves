...
{ // Inicio da função start()
	...
	function movejogador () 
	{
			...
			function moveinimigo1 () 
			{
				...
				$("#inimigo1").css ("left", posicaoX - velocidade - velocidadeC);
			...
			function movevida () 
			{
				posicaoX = parseInt ($("#vida").css ("left"));
				$("#vida").css ("left", posicaoX - velocidadeD);
			...
			} //Fim da função movevida()

			function moveinimigo2 () 
			{
                 posicaoX = parseInt ($("#inimigo2").css ("left"));
	             $("#inimigo2").css ("left", posicaoX - velocidadeB - velocidadeC);
            ...
            function colisao () 
			{
	            ...
	            // jogador com o inimigo1
		         ...
		         if (colisao7.length > 0) 
				 {
			         ...
			         vidaX = parseInt ($("#vida").css ("left"));
			         vidaY = parseInt ($("#vida").css ("top"));
